...
docker build --file 3.11/browsers-jre17/Dockerfile -t cimg/python:3.11.3-browsers-jre17 -t cimg/python:3.11-browsers-jre17 --platform linux/amd64 .
...
docker build --file 3.10/browsers-jre17/Dockerfile -t cimg/python:3.10.11-browsers-jre17 -t cimg/python:3.10-browsers-jre17 --platform linux/amd64 .
